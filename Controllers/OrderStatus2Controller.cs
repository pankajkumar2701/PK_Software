...
using PKSoftware.Data;
using PKSoftware.Filter;

namespace PKSoftware.Controllers
{
    /// <summary>
    ...
    {
        private readonly PKSoftwareContext _context;

        public OrderStatus2Controller(PKSoftwareContext context)
        {
            _context = context;
        }
